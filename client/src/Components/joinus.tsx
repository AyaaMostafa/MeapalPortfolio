    ...
    <div>
      ...
      <div className="join-us-container">
        <h1 className="join-us-title">
          Join <span className="red-text">us</span>
        </h1>
        <p className="join-us-subtitle">Invest in your talent - join us!</p>
        <p className="join-us-description">
          We are always on the lookout for new talents. Whatever your talent, whatever your level of <br/> experience, come and show us what you can do. We’ll take the time to have a warm and fully <br/> confidential talk with you. We believe in the profusion of your talents and that is what we invest in, so <br/> the contracts for our positions are open-ended.
        </p>
